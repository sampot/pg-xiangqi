...
- **Kenney** — [UI Audio](https://kenney.nl/assets/ui-audio)（Kenney Vleugels）
- **授權：** CC0 1.0
- 詳見 `assets/sfx/License.txt`

## 音樂（勝局 jingle）

- **Kenney** — [Music Jingles](https://kenney.nl/assets/music-jingles)（Kenney Vleugels）
- **授權：** CC0 1.0
- 詳見 `assets/music/License.txt`
